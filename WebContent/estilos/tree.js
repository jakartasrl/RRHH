...
function createTree(arrName, startNode, openNode) {
	...
	if (nodes.length > 0) {
		...
		if (startNode !=0) {
			...
			var miOnMOver = "style.background='#ABCDEF'; setOID(" + nodeValues[0] + ");";
			var miOnMOut  = "style.background='#FFFFFF';";
			document.write("<a class='conMenu' href=\"" + nodeValues[3] + "\" onmouseover=\"window.status='" + nodeValues[2] + "';" + miOnMOver + "return true;\" onmouseout=\"window.status=' '; " + miOnMOut + "return true;\"><img src=\"img/folderopen.gif\" align=\"absbottom\" alt=\"\" />" + nodeValues[2] + "</a><br />");
		} else document.write("<img src=\"img/office.jpg\" align=\"absbottom\" alt=\"\" />Empresa<br />");
...
function addNode(parentNode, recursedNodes) {
	for (var i = 0; i < nodes.length; i++) {
		...
		if (nodeValues[1] == parentNode) {
			...
			document.write("<a class='" + clase + "' href=\"" + nodeValues[3] + "\" onmouseover=\"window.status='" + nodeValues[2] + "';" + miOnMOver + "return true;\" onmouseout=\"window.status=' '; " + miOnMOut + "return true;\">");
			...
			} else document.write("<img id=\"icon" + nodeValues[0] + "\" src=\"img/muneco.png\" align=\"absbottom\" alt=\"Page\" />");
...
function oc(node, bottom) {
	...
	var thea    = document.getElementById("a" + node);
